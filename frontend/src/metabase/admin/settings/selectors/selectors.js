    ...
    settings: [
      {
        ...
        description: t`API key for OpenAI services`,
        type: "string",
        required: true,
        placeholder: "sk-...",
        sensitive: true,
      ...
      {
        key: "index-db-user",
        display_name: t`Index DB Username`,
        description: t`Username for the Index Database`,
        type: "string",
        required: true,
      },
      {
        key: "index-db-password",
        display_name: t`Index DB Password`,
        description: t`Password for the Index Database`,
        type: "string",
        required: true,
        sensitive: true,
      },
      {
        key: "index-db-name",
        display_name: t`Index DB Name`,
        description: t`Name of the Index Database`,
        type: "string",
        required: true,
      },
      {
        key: "index-db-host",
        display_name: t`Index DB Host`,
        description: t`Host address for the Index Database`,
        type: "string",
        required: true,
      ...
      {
        key: "index-db-port",
        display_name: t`Index DB Port`,
        description: t`Port number for the Index Database`,
        type: "integer",
        required: true,
        placeholder: "5432",
      },
